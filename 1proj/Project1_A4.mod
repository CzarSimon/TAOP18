...
# Som en heurestik provar vi att hitta lösnignar efter att vi först bestämt vilka DC som ska vara öppna.
# Vi ändrar sedan successivt vilka som är öppna och ser vilket alternativ som blir bäst.
